        ...
        <div className="container">
          <div className="flex flex-wrap relative lg:p-12">
            <div className="w-full self-center px-4 lg:w-1/2 absolute z-10 -bottom-10 md:bottom-0 md:static md:z-0">
              ...
              <h2 className="font-extrabold drop-shadow-lg md:drop-shadow-none md:font-medium text-secondary text-lg mt-1 mb-5 lg:text-xl">Fullstack Developer & <span className="text-dark">Youtuber Gaming</span></h2>
